			...
			<div class="col-lg-12 col-md-12 mb-4">
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">Transaksi KAS Keluar</h3>
					</div>
					<div class="card-body">
						<form method="POST" action="{{ url('admin/pengeluaran') }}">
							{{ csrf_field() }}
							...
							<div class="row">
								<div class="col-lg-6 col-md-6 col-xs-12">
									<div class="form-group">
										...
										<input class="form-control" type="number" name="saldo" required="" placeholder="Rp ...">	
									</div>
									<div class="form-group">
								...
								<div class="col-lg-6 col-md-6 col-xs-12">
									...
									<div class="form-group">
										<label>Keluar Ke</label>
										<select name="keluar_ke" class="form-control">
									...
									<div class="form-group">
										...
										<textarea class="form-control" name="description" required="" placeholder="Keterangan ..."></textarea>
									</div>
								</div>

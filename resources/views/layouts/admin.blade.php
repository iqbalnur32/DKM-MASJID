...
<body class="hold-transition sidebar-mini layout-fixed" style="height: auto;">
    ...
    <script src="/adminlte/plugins/datatables-buttons/js/buttons.flash.min.js"></script>
    ...
    <!-- Assets Majid JS -->
    <script type="text/javascript" src="/assets/data_masjid.js"></script>
    <!-- Assets DKM -->
    <script type="text/javascript" src="/assets/dkm.js"></script>
    <!-- Absensi JS -->
    <script type="text/javascript" src="/assets/absensi.js"></script>
    ...
    <script type="text/javascript">
     $(document).ready(function(){
      ...
      // alert(provinsi);
      $.ajax({
        url: 'http://127.0.0.1:8000/provinsi' + provinsi,
        type: 'GET',
        dataType: 'json',
